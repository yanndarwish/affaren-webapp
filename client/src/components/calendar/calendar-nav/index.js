...
export default function CalendarNav({
	...
	const selectedMonth = getMonth(currentView, viewedDate)
	const selectedDay = viewedDate.getDate()
	const selectedYear = getYear(currentView, viewedDate)
	...
	return (
		<div className="flex flex-wrap min-w-full justify-between items-center gap-4">
			...
			<div className="flex flex-wrap space-x-4 justify-center">
				...
				<Button onClick={handleClickAddEvent}>
